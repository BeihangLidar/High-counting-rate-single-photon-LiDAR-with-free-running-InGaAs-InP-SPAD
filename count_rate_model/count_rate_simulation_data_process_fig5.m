...
for j=1:length(Ns_ground_truth)
    for i=0.5e5:0.5e5:50e5
        filename=['E:\13.SPL_code\optica代码数据\spl_driver_V10_house_20250125\data\paper\optica\optica_simulation\count_rate\fr_',num2str(i),'fn_0k_Ns_',num2str(Ns_ground_truth(j)),'.mat'];
        load(filename);
